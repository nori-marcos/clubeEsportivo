...
VALUES ('02039461388', 'Simone Beatriz da Luz', 'foto',
        '2021-01-01', '1990-01-01', 'Avenida das Cerejeiras, 123 - Jardim das Flores', 'simone_daluz@fosj.unesp.br',
        NULL, 1),
       ('42331337322', 'Ester Regina da Rocha', 'foto',
        '2021-01-01', '1990-01-01', 'Travessa dos Girassóis, 45 - Vila dos Pássaros',
        'ester_regina_darocha@schon.com.br',
        '02039461388', 2),
       ('87166405600', 'Tânia Sara da Luz', 'foto',
        '2021-01-01', '1990-01-01', 'Rua dos Ipês, 789 - Bosque Encantado', 'tania-daluz95@jp.ind.br',
        NULL, 3),
       ('20703896695', 'Márcia Maya Almada', 'foto',
        '2021-01-01', '1990-01-01', 'Alameda das Magnólias, 456 - Parque das Árvores', 'marcia_almada@i9tec.com.br',
        NULL, 4),
       ('48169743346', 'Isaac Erick Dias', 'foto',
        '2021-01-01', '1990-01-01', 'Estrada dos Pinheiros, 22 - Reserva Verde', 'isaac_erick_dias@wnetrj.com.br',
        '02039461388', 5),
       ('28373246711', 'João Pedro da Silva', 'foto',
        '2021-01-01', '1990-01-01', 'Rua das Oliveiras, 321 - Vila das Estrelas', 'joao@email.com',
        '20703896695', 6);
